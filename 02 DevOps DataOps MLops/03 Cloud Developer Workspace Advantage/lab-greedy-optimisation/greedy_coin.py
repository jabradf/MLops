...
@click.argument("dollars", type=int)
@click.option("--cents", type=int, default=0)
#def main(change):
def main(dollars, cents):
    ...
    # no need to check for negative numbers as Click handles this as an input option
